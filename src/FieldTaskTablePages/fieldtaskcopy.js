...
const Fieldtaskcopy = () => {
    ...
    const { field, placeholder_message, error_message, inactive, note } = user;
    ...
    const LoginFunctiontaskfield = (event) => {
        ...
        fetch(`https://teammember.techpanda.art/api/user/taskfieldmaster/`, {
            ...
            .then((Response) => {
                console.log('RESPONSE LoginFunctiontaskfield apiiii-11111111------------->>>>', Response)
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-5">
                            <div className='text-center mb-3'>
                                <h3>Task Field Master  - Task Field Master Record - Make Copy Of Task Field</h3>
                            </div>
                        </div>
                                                ...
                                                <form>
                                                    <div className="form-group mb-3">
                                                        <div className="row mt-2">
                                                            ...
                                                            <div className="col-sm-6">
                                                                <input placeholder={taskplaceholder} list='tasksearchtask' type="text" className="form-control" value={task} onChange={e => onInputChanget(e)} />
                                                            </div>
                                                        ...
                                                        <div className="row mt-2">
                                                            ...
                                                            <div className="col-sm-6">
                                                                <input className="form-control" list='tasksearchfield' type="text" placeholder={descriptionplaceholder} value={description} onChange={e => onInputChanget(e)} />
                                                            </div>
                                                        </div>
                                                        <div className="row mt-2">
                                                            <div className='col-sm-4'><h6>Pyname</h6></div>
                                                            <div className="col-sm-6">
                                                                <input className="form-control" list='tasksearchfield' type="text" placeholder={pynameplaceholder} value={pyname} onChange={e => onInputChanget(e)} />
                                                            </div>
                                                        </div>
                                                        <div className="row mt-2">
                                                            <div className='col-sm-4'><h6>Note</h6></div>
                                                            <div className="col-sm-6">
                                                                <input className="form-control" list='tasksearchfield' type="text" placeholder={noteplaceholder} value={notes} onChange={e => onInputChanget(e)} />
                                                            </div>
                                                        </div>
                                                        <div className="row mt-2">
                                                ...
                                                <form>
                                                    <div className="form-group mb-3">
                                                        ...
                                                        <div className="row mt-2">
                                                            ...
                                                            <div className="col-sm-6">
                                                                <input className="form-control" list='tasksearchfield' type="text" placeholder={placeholdermessage} value={placeholder_message} onChange={e => onInputChange(e)} />
                                                            </div>
                                                        </div>
                                                        <div className="row mt-2">
                                                            <div className='col-sm-4'><h6>Error Message</h6></div>
                                                            <div className="col-sm-6">
                                                                <input className="form-control" list='tasksearchfield' type="text" placeholder={errormessage} value={error_message} onChange={e => onInputChange(e)} />
                                                            </div>
                                                        </div>
                                                        <div className="row mt-2">
                                                            <div className='col-sm-4'><h6>Note</h6></div>
                                                            <div className="col-sm-6">
                                                                <input className="form-control" list='tasksearchfield' type="text" placeholder={noteplaceholder} value={note} onChange={e => onInputChange(e)} />
                                                            </div>
                                                        </div>
                                                        <div className="row mt-2">
                                                            <div className='col-sm-4'><h6>Inactive</h6></div>
