...
const Taskfieldmastertwo = () => {
    ...
    // const pageCount = CustomData1 ? Math.ceil(CustomData1.length / pageSize) : 0;
    ...
    //     const pagined = _(CustomData1).slice(startIndex).take(pageSize).value();
    //     setpagined(pagined);
    // }

    ///////taskfieldaccess////
    const [taskfieldaccesstwo, setTaskFieldaccesstwo] = useState([])
                    ...
                    // console.log("all erroe msg", Features[i]);
                        ...
                        for (let index = 0; index < Features.length; index++) {
                            ...
                            //   console.log("9034444444444taskfield447",Features[index]);
                              setTaskFieldaccesstwo(Features[index])
    ...
    // console.log("taskmasterfield????",taskfieldaccesstwo);
                ...
                <div>
                    <ul className="nav nav-tabs" id="myTab" role="tablist">
                        <li className="nav-item">
                            <a className="nav-link active" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Task Field Master By Task</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link " id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Task Field Master By Field</a>
                        </li>
                            ...
                            <div className="table-search mt-3">
                                <div className="row">
                                    ...
                                    <div className="col-lg-1">
                                        <div className="plus-icon">
                                            <Link to={`/taskmaster/${fieldtabledatashow.state.Item.id}`} >
                                ...
                                <div className="field-table">
                                    <div class="table-responsive">
                                        <table className="table table-hover">
                                            ...
                                            <tbody>
                                                {CustomData1.map((item, index) => (
                                                    <tr key={index} >

                                                        <td>
                                                            <Link to={`/fieldtaskview/${item.id}`}>
                                                                {item.task}
                                                            </Link>
                                                        </td>
...
export default Taskfieldmastertwo;
