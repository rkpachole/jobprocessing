                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" type="text" name='field' placeholder={fieldplaceholder} value={field} onChange={e => onInputChange(e)} />
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" type="text" name='placeholder_message' placeholder={placeholdermessage} value={placeholder_message} onChange={e => onInputChange(e)} />
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" type="text" name='error_message' placeholder={errormessage} value={error_message} onChange={e => onInputChange(e)} />
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" maxLength={40} type="text" name='detail_message' placeholder={detailmessage} value={detail_message} onChange={e => onInputChange(e)} />
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" type="text" name='note' placeholder={noteplaceholder} value={note} onChange={e => onInputChange(e)} />
                                        </div>
                                    </div>
                                </div>
