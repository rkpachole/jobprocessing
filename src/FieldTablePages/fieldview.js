                        ...
                        <div className='col-xl-12'>
                            ...
                            <form className="form-area">
                                ...
                                <div className='views-icons' data-dismiss="modal" aria-label="Close">
                                    ...
                                    <Link to={`/fieldinactive/${id}`} >

                                        <i class="fa fa-times" aria-hidden="true"></i>
                                      </Link >
                                      <Link to={`/fieldactive/${id}`} ><i class="fa fa-check" aria-hidden="true"></i></Link >
                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" type="text" placeholder={fieldplaceholder} value={field} onChange={e => onInputChange(e)} />
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" type="text" placeholder={placeholdermessage} value={placeholder_message} onChange={e => onInputChange(e)}
                                            />
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" type="text" placeholder={errormessage} value={error_message} onChange={e => onInputChange(e)}
                                            />
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" maxLength={40} type="text" placeholder={detailmessage} value={detail_message} onChange={e => onInputChange(e)}
                                            />
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" type="text" placeholder={noteplaceholder} value={note} onChange={e => onInputChange(e)}
                                            />
                                        </div>
                                    </div>
                                </div>
