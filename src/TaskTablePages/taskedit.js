...
const Taskedit = () => {
    ...
    const updatepagetaskedit = () => {
        axios.put(`https://teammember.techpanda.art/api/user/taskmaster/${id}/`, {
            task,
            description,
            pyname,
            notes,
    ...
    return (
        <>
            {/* {taskeditsuc ?(alert("loginsuccess")):null }
        {taskeditin ?(alert("task master with this task already exists.")):null } */}
            <TableHeader />
            <section>
                        ...
                        <div className='col-xl-12'>
                            ...
                            <form onSubmit={LoginFunctiontask} className="form-area">
                                <div className='text-right mb-3'>
                                    <button className='main-btn' onClick={updatepagetaskedit} data-toggle="modal" data-target=".error-popup">
                                        <span>Edit</span>
                                    </button>
                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input placeholder={taskplaceholder} type="text" name='task' className="form-control" value={task} onChange={e => onInputChange(e)} />
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" type="text" name='description' placeholder={descriptionplaceholder} value={description} onChange={e => onInputChange(e)} />
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" type="text" name='pyname' placeholder={pynameplaceholder} value={pyname} onChange={e => onInputChange(e)} />
                                        </div>
                                    </div>
                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" type="text" name='notes' placeholder={noteplaceholder} value={notes} onChange={e => onInputChange(e)} />
                                        </div>
                                    </div>
                                </div>
