...
const Taskdelete = () => {
    ...
    const { task, description, pyname, notes } = user;
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-4">
                            <div className='text-center mb-3'>
                                <h3>Task Master  - Delete task Forever</h3>
                            </div>
                        </div>
                        ...
                        <div className='col-xl-12'>
                            ...
                            <form className="form-area">
                                <div className='text-right mb-3'>
                                    <button className='main-btn' onClick={() => deleteuser(id)}>
                                        <span>Confirm</span>
                                    </button>
                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            ...
                                            <input placeholder={taskplaceholder} type="text" className="form-control" value={task} readonly="readonly" onChange={e => onInputChange(e)} />
                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            ...
                                            <input className="form-control" type="text" placeholder={descriptionplaceholder} value={description} readonly="readonly" onChange={e => onInputChange(e)} />
                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            ...
                                            <input className="form-control" type="text" placeholder={pynameplaceholder} value={pyname} readonly="readonly" onChange={e => onInputChange(e)} />
                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            ...
                                            <input className="form-control" type="text" placeholder={noteplaceholder} value={notes} readonly="readonly" onChange={e => onInputChange(e)} />
