                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" type="text" name='task' placeholder={taskplaceholder} value={task} onChange={e => onInputChange(e)} />
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" name='description' type="text" placeholder={descriptionplaceholder} value={description} onChange={e => onInputChange(e)} />
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group mb-3">
